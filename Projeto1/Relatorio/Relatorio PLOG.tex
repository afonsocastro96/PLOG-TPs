...
O jogador preto pode afundar quaisquer peças que estejam marcadas com uma estrela. Nenuma peça branca está numa posição que lhe permita afundar alguma peça.
...
\textit{Descrever a forma de visualização do tabuleiro em modo de texto e o(s) predicado(s) Prolog construídos para o efeito.
...
\textit{Elencar os movimentos (tipos de jogadas) possíveis e definir os cabeçalhos dos predicados que serão utilizados (ainda não precisam de estar implementados).}
